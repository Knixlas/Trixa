...
def get_plan_tool() -> dict:
    ...
    return {
        ...
        "description": (
            ...
            "ETT PASS = EN SESSION. Kombinera ALDRIG tva sporter i samma session. "
            "Om en dag har bade lop och styrka: skapa TVA sessions med samma datum men olika sport. "
            "ALDRIG title='Lop 30 min + Styrka 30 min' — ALLTID tva separata sessions. "
